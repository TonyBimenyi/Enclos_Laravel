            ...
            <div class="form_vrai">
                <form action="/depense" method="POST">
                   ...
                   <!-- <input type="text" value="" name="type" ><br><br>-->
                    ...
                    <input type="number" name="montant" placeholder="Entez le montant de depense..." value=""><br><br>

                    <label for="">Date:</label><br>
                    <input type="date" required="[0-9]" name="date" placeholder="Entrez la classe..."><br><br>
