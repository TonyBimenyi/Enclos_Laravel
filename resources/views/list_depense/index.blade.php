...
<div class="container_accueil">
    <div class="top_bar_buttons">
        ...
        <div class="code">
            ...
            {{ $sum=DB::table("deps")->get()->sum("montant_depense") }}
        </div>

        <div class="search_bar">
            <form type="get" action="{{ url('/searchDepense') }}">

                          <div class="section">
                              <select name="type" id="">
                                  <option value=""></option>
                                  @foreach ($types as $ty)
                                      <option value="{{ $ty->type_depense }}">{{ $ty->type_depense }}
                                      </option>
                                  @endforeach
                              </select><br><br>
                          </div>
                ...
                <div class="liste_type_depense">
                    ...
                    <div class="table">
                        <table>
                            ...
                            <tbody>
                                @foreach ($dep as $depense)
                                <tr>
                                <td>{{ $depense->type_depense }}</td>
                                <td>{{ number_format($depense->montant_depense) }} Fbu</td>
                                <td>{{ $depense->date_depense }}</td>
                                <td>{{ $depense->description_depense }}</td>
                                <td>{{ $depense->created_at }}</td>
                                <td>{{ $depense->user }}</td>
                                <div class="delete">
                                    <td><a href="/depense/{{ $depense->id }}/edit">Modifier</a></td>
                                </div>
                                <div class="delete">
                                    <td id="ajouter"><a href="">Ajouter</a></td>
                                </div>
                                </div></td>
                                <td>
                                    <div class="delete">
                                    <form action="/depense/{{ $depense->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
