...
<div class="container_accueil">
        ...
        <div class="form-title">
            <h1>Modifier revenus </h1>
        </div>
                <div class="form">

            <div class="form_vrai">
                <form action="/revenu/{{ $revenus->id }}" method="POST">
                    @csrf
                    @method('PUT')
                   ...
                   <!-- <input type="text" value="" name="type" ><br><br>-->
                    ...
                    <input type="number" name="montant" value="{{ $revenus->montant_revenu }}"><br><br>

                    <label for="">Date:</label><br>
                    <input type="date" required="[0-9]" name="date" placeholder="Entrez la classe..." value="{{ $revenus->date_revenu }}"><br><br>
                    <label for="">Description:</label><br>
                    <textarea name="description" id=""  >{{ $revenus->description_revenu }}</textarea><br><br>
