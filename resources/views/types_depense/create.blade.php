...
<div class="container_accueil">
        ...
        <div class="form-title">
            <h1>Ajouter type depenses</h1>
        </div>
        <div class="form">

            <div class="form_vrai">
                <form action="/types_depense" method="POST">
                    @csrf
                    <label for="">Types:</label><br>
                    <input type="text" placeholder="Entrer un type de depense" name="type" ><br><br>
                   <!-- <label for="">Montant:</label><br>
                    <input type="number" name="montant" placeholder="Entez le prenom..."><br><br>
