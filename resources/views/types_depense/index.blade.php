        ...
        <div class="container_types_depenses">
                  ...
                  <div class="form">
                      <form action="" method="POST">
                        <!-- <p> <input id="input" type="text" name="type_depense" placeholder="Tapez un type"></p><br>-->
                         <a href="{{ route('types_depense.create') }}" id="submit">Ajouter un type</a>
                      </form>
                  </div>
                   <br>
                   <div class="line">
                ...
                <div class="liste_type_depense">
                    <div class="title_type_depense">
                        <h1>Liste des types de dépenses</h1>
                    </div>
                    <div class="table">
                        <table>
                            <thead>
                            ...
                            <tbody>
                                @foreach ($type_depense as $type)
                                <tr>
                                <td>{{ $type->id }}</td>
                                <td>{{ $type->type_depense }}</td>
                                <td>
                                    <div class="delete">
                                    <form action="/types_depense/{{ $type->id }}" method="POST">
                                        @csrf
                                        @method('DELETE')
