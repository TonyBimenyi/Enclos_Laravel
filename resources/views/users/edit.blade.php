            ...
            <div class="form_vrai">
                <form action="/users/{{ $User->id }}" method="POST">
                   ...
                   {{--  <!-- <input type="text" value="" name="type" ><br><br>-->
                    ...
                    <input type="text" value="{{ $User->name }}" name="name" placeholder="Entez le nom et prenom..." value=""><br><br>

                    <label for="">Username:</label><br>
                    <input type="name" required="" value="{{ $User->email }}" name="username" placeholder="Entrer un nom d utilisateur.."><br><br>
